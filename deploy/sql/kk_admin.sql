...
Source Database       : kk_admin

Target Server Type    : MYSQL
Target Server Version : 80033
File Encoding         : 65001

Date: 2023-08-10 19:13:02
*/
...
CREATE TABLE `sys_dictionary` (
  ...
  `update_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统参数';
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES ('1', '技术', '1', '0', '2022-08-17 07:15:56.000000', '2023-08-10 19:00:49.000000');
...
CREATE TABLE `sys_log` (
  ...
  `update_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统日志';
...
CREATE TABLE `sys_perm_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='权限&菜单';
